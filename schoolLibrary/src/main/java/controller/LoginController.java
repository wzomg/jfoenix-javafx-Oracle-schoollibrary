        ...
        if(list.size() == 0) {
            ...
            if(!NowPasswd.equals(pwd)) {
                ...
                if(flag == 1) {
                    ...
                    //读者
                    Integer rStatus = Integer.parseInt(list.get(0).get("RState").toString());
                    if(rStatus == 2) {
                    ...
                    //设置隐藏属性的值
                    Main.rc.InitData(Id, (String) list.get(0).get("RName"), Integer.parseInt(list.get(0).get("RState").toString()) == 1 ? "挂失" : "正常");
                    loginMsg.setText("登录成功~");
                } else {
                    //工作人员
