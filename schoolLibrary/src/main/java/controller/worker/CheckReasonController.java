...
public class CheckReasonController {
    ...
    //提交违约信息
    @FXML
    public void addBorrowClick() throws ParseException {
        ...
        int cnt1 = template.update(sql, bookId.getText(), readerId.getText(), Main.sdf.parse(StartTime.getText()), Main.sdf.parse(endTime.getText()), reasonWhy);
        if(cnt1 > 0) {
