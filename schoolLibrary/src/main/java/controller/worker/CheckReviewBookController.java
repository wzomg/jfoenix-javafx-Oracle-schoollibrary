...
public class CheckReviewBookController {
    ...
    //查询
    @FXML
    public void searchReviewClick() throws ParseException {
        ...
        Integer bst = Integer.parseInt(forMap.get("BStatus").toString());
        ...
        if(bst == 1) {
            ...
            if(buttonType.isPresent() && buttonType.get() == ButtonType.OK) {
                ...
                int update = template.update(sql, reviewBookItem.getBId(), reviewBookItem.getRId(), Main.sdf.parse(reviewBookItem.getQSDate()), Main.sdf.parse(reviewBookItem.getQEDate()));
                if(update > 0) {
