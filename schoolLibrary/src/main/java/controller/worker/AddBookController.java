...
public class AddBookController {
    ...
    @FXML
    public void addSureClick() throws ParseException {
        ...
        int cnt = template.update(sql, bid, bName, bAuthor, bkindId, Double.valueOf(bPrice), Main.sdf.parse(bDate.toString()), bPress, bSummary);
        if(cnt > 0) {
