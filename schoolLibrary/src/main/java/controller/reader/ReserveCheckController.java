...
public class ReserveCheckController {
    ...
    @FXML
    public void addReserveClick() throws ParseException {
        labelMsg.setText("");
        ...
        System.out.println(startTime + " " + endTime.toString());
        //将日期字符串转化成Date类型
        int num = template.update(sql, bid, rid, Main.sdf.parse(startTime), Main.sdf.parse(endTime.toString()));
